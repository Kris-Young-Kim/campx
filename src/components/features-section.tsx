...
import { Brain, Map, Smartphone } from "lucide-react"
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            계획부터 철수까지, 캠핑의 모든 순간을 CampX가 함께합니다.
          </p>
        </motion.div>
        ...
        >
          {features.map((feature) => (
            <motion.div
              ...
              className="group relative bg-card/70 backdrop-blur-xl border border-border rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all"
            >
              {/* Icon */}
              <div
