...
export const users = pgTable("users", {
  ...
  preferenceVector: vector("preference_vector", { dimensions: 3 }),
  healthCondition: integer("health_condition").default(5), // 1-10, 높을수록 건강
  hasPet: boolean("has_pet").default(false),
  familySize: integer("family_size").default(1),
  bioDataJson: jsonb("bio_data_json"), // 추가 프로필 데이터
